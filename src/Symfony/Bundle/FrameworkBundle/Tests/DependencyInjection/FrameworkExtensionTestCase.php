...
abstract class FrameworkExtensionTestCase extends TestCase
{
    ...
    public function testWebhook()
    {
        ...
        $this->assertEquals('webhook.payload_encoder.serializer', $container->getDefinition('webhook.body_configurator.json')->getArgument(0));
    }
    ...
    public function testWebhookWithoutSerializer()
    {
        ...
        $this->assertFalse($container->getDefinition('webhook.transport')->hasErrors());
        $this->assertEquals('webhook.payload_encoder.json', $container->getDefinition('webhook.body_configurator.json')->getArgument(0));
    }
