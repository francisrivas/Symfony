...
$wh = new MailerEngagementEvent(MailerEngagementEvent::SPAM, '7761638', json_decode(file_get_contents(str_replace('.php', '.json', __FILE__)), true, flags: JSON_THROW_ON_ERROR)['mandrill_events']);
