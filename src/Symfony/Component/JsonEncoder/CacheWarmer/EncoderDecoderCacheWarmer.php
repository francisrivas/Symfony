...
final readonly class EncoderDecoderCacheWarmer implements CacheWarmerInterface
{
    ...
    public function __construct(
        ...
        $this->encoderGenerator = new EncoderGenerator(new EncodeDataModelBuilder($encodePropertyMetadataLoader), sprintf('%s/json_encoder/encoder', $cacheDir));
        $this->decoderGenerator = new DecoderGenerator(new DecodeDataModelBuilder($decodePropertyMetadataLoader), sprintf('%s/json_encoder/decoder', $cacheDir));
    }
