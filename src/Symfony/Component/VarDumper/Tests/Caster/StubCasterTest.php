...
use Symfony\Component\VarDumper\Caster\VirtualPropertyStub;
...
EODUMP;
    ...
    public function testVirtualPropertyStub()
    {
        ...
        $args = [new VirtualPropertyStub($class->getProperty('fullName'))];
...
EODUMP;
    ...
    {
        $class = new \ReflectionClass(VirtualProperty::class);
        $args = [new VirtualPropertyStub($class->getProperty('noType'))];
